import { anyEquals, flatten as flattenHelper, type Monad } from "./helpers";
import { Just, type Maybe, nothing, Nothing } from "./maybemonad";
...
export class Left<L> extends EitherBase<L, never> {
    ...
    public flatMap(f: (x: never) => Left<L> | Right<never>): Either<L, never> {
        return this;
    }
